	...
	<div class="listRow">
		<div class="listRowInside">
			...
			<div class="listcontent1 ml-4" style="width: 500px;" data-toggle="modal" data-target="#myListModal">
				<span style="font-weight: bold;"><span style='font-size:100px;  font-size: 20px;'>&#128226;</span> <%-- 중요 공지사항 이모지 붙이기 --%>
				...
				<div>
				<span style="font-size: 10pt; color: gray; display: inline-block;"> ┗ 댓글</span>
				</div>	
			</div>
  ...
  <div class="modal-dialog modal-dialog-scrollable modal-right modal-md">
	    ...
	    <div class="modal-content">
	      <div class="modal-header">
	        <h4 class="modal-title" id="myListModalTitle">전체 공지 </h4>
